...
public class GLCMClusteringDialog extends JDialog {
	...
	public static void main(final String[] args) {
		try {
			final GLCMClusteringDialog dialog= new GLCMClusteringDialog();
	...
	public void deconvolveViaCommand() {
		...
		cmd.run(GLCMClusteringOp.class, true, "img", img, "sxy", 3, "sz", 7,
			"numIterations", 50);
    ...
    private void initComponents() {
        ...
        // Generated using JFormDesigner Evaluation license - Serikzhan
